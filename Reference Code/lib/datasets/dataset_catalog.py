...
DATASETS = {
    ...
    'common_train': {
        IM_DIR:
            _DATA_DIR + '/common/images/train',
        ANN_FN:
            _DATA_DIR + '/common/annotations/instances_train.json',
    },
    'common_val': {
        IM_DIR:
            _DATA_DIR + '/common/images/val',
        ANN_FN:
            _DATA_DIR + '/common/annotations/instances_val.json',
    },
    'kitti_train': {
        IM_DIR:
            _DATA_DIR + '/kitti/images/train',
        ANN_FN:
            _DATA_DIR + '/kitti/annotations/instances_train.json',
    },
    'kitti_val': {
        IM_DIR:
            _DATA_DIR + '/kitti/images/val',
        ANN_FN:
            _DATA_DIR + '/kitti/annotations/instances_val.json',
    },
