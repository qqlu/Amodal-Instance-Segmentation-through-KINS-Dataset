...
class JsonDatasetAmodal(object):
    ...
    def valid_cached_keys(self):
        ...
        """
        keys = ['boxes', 'segms', 'segms_amodal', 'gt_classes', 'seg_areas', 'gt_overlaps',
    ...
    def _add_gt_annotations(self, entry):
        ...
        for obj in objs:
            ...
            if obj['area'] > 0 and x2 > x1 and y2 > y1:
                ...
                valid_segms_amodal.append(obj['amodal'])
    ...
    def _add_gt_from_cache(self, roidb, cache_filepath):
        ...
        for entry, cached_entry in zip(roidb, cached_roidb):
            ...
            boxes, segms, segms_amodal, gt_classes, seg_areas, gt_overlaps, is_crowd, \
                box_to_gt_ind_map = values[:8]
            if self.keypoints is not None:
