...
from .json_dataset_amodalinmodalseg import JsonDatasetAmodalInmodalSeg as JsonDataset
...
def extend_with_flipped_entries(roidb, dataset):
    ...
    for entry in roidb:
        ...
        flipped_entry = {}
        dont_copy = ('boxes_amodal', 'boxes_inmodal', 'segms_amodal', 'segms_inmodal', 
                    'segms_invisible_full', 'gt_keypoints', 'flipped')
