...
def add_rpn_blobs(blobs, im_scales, roidb):
    ...
    for im_i, entry in enumerate(roidb):
        ...
        gt_rois = entry['boxes_amodal'][gt_inds, :] * scale
    ...
    if not cfg.MODEL.INMODAL_ON:
        ...
        valid_keys = [
            'has_visible_keypoints', 'boxes_amodal', 'boxes_inmodal', 'segms_amodal', 'segms_inmodal', 
            'segms_amodal_areas', 'gt_classes', 'gt_overlaps', 'is_crowd', 'box_to_gt_ind_map', 
            'gt_keypoints', 'segms_invisible_full', 'amodal_label'
        ]
