...
from roi_data.loader_amodalinmodalseg import RoiDataLoader, MinibatchSampler, BatchSampler, collate_minibatch
from modeling.model_builder_amodalinmodalseg_split_amodal_class_feature_fusion import Generalized_RCNN
import utils.blob as blob_utils
from utils.detectron_weight_helper import load_detectron_weight
from utils.logging import setup_logging_to_file
...
def save_ckpt(output_dir, args, step, train_size, model, optimizer, logger):
    """Save checkpoint"""
    if args.no_save:
        return
